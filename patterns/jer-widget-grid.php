...
<div class="wp-block-group wp-block-group-is-layout-constrained" style="margin-top:var(--wp--preset--spacing--50);">
	<!-- wp:group {"className":"alignwide","layout":{"type":"default"}} -->
	<div class="wp-block-group alignwide">
		...
		<div class="wp-block-columns">
			...
			<div class="wp-block-column">
				...
				<!-- /wp:paragraph -->
				<!-- wp:paragraph -->
				<p>See the <a href="/hire-me/">Hire Me</a> page for details and please <a href="/contact/" data-type="page" data-id="783">get in touch</a> 🙏🏻</p>
				<!-- /wp:paragraph --></div>
			<!-- /wp:column -->
			<!-- wp:column -->
			<div class="wp-block-column">
				...
				<!-- /wp:paragraph -->
				<!-- wp:paragraph -->
				<p>Check out my <a href="/photography-portfolio/">photography portfolio</a> to see more.</p>
				<!-- /wp:paragraph --></div>
			<!-- /wp:column -->
			<!-- wp:column -->
				<div class="wp-block-column">
				...
				<!-- /wp:paragraph -->
				<!-- wp:paragraph -->
				<p>Learn more on my <a href="https://www.youtube.com/channel/UChHJFiABRflW6y2Jvas9VQQ">YouTube Channel</a>!</p>
				<!-- /wp:paragraph --></div>
			<!-- /wp:column --></div>
		<!-- /wp:columns --></div>
	<!-- /wp:group --></div>
